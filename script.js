...
import { getFirestore, collection, getDocs, addDoc, query, where, updateDoc, increment, doc } from "https://www.gstatic.com/firebasejs/10.7.0/firebase-firestore.js";

// Your web app's Firebase configuration
const firebaseConfig = {
    apiKey: "AIzaSyBxhwzK_MLwRdN1R8ik-yuVmxYt87RWlb0",
    authDomain: "frontend-dfab3.firebaseapp.com",
    projectId: "frontend-dfab3",
    storageBucket: "frontend-dfab3.appspot.com",
    messagingSenderId: "226275591520",
    appId: "1:226275591520:web:716fc05f61fea16d340a05"
};
...
async function getHighscore() {
    ...
    highscoreList.forEach((highscore) => { // Loopar igenom våran collection
...
async function checkIfUsernameExists() {
    ...
    const usernameQuery = query(collection(db, 'highscore'), where('username', '==', username));
...
async function updateHighscore(userId) {
    await updateDoc(doc(db, 'highscore', userId), { // Anger vilket dokumentId som vi ska uppdatera
